...
const Parser = dynamic(() => import('@/components/react-markdown/parser').then((mod) => mod.Parser), { ssr: false });
    ...
    <div>
      ...
      <div className="mt-2 flex justify-end">
        <button
          ...
          onClick={async () => {
            if (!comment) return;
            const result = await commentOnNote(noteId, comment).catch((e) => null);
            if (result) {
              setComment('');
